...
public sealed class UpdateRaidItemRequestDtoValidator : AbstractValidator<UpdateRaidItemRequestDto>
{
    public UpdateRaidItemRequestDtoValidator()
    {
        RuleFor(x => x.Type)
    ...
    private static bool HasConditionalRiskFields(UpdateRaidItemRequestDto request)
    {
